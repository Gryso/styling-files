    ...
    <>
      ...
      <ul>
        ...
        <li> here we have some
          <del>deleted</del>
          text (<code>del</code> markup used)
        </li>
        <li> an <dfn>octet</dfn> is an entity consisting of eight bits</li>
        ...
        <li> here we have some</li>
        <ins>inserted</ins>
        text (<code>ins</code> markup used)
        ...
        <li> (<code>strike</code> markup used; note:
        ...
        <li> (<code>tt</code> markup used)</li>
      ...
      <form action="http://www.cs.tut.fi/cgi-bin/run/~jkorpela/echo.cgi">
        <div>
          <nput name="hidden field" type="hidden" value="42"/>
        ...
        <div><label htmlFor="but">Button:
          <button id="but" name="foo" type="submit" value="bar">A cool button</button>
        </label>
        </div>
        <div><label htmlFor="f0">Reset button:
          <input id="f0" name="reset" type="reset" value="Reset"/></label>
        </div>
        <div><label htmlFor="f1">Single-line text input field: <input id="f1" name="text" size="20"
                                                                      value="Default text."/></label></div>
        <div><label htmlFor="f2">Multi-line text input field (textarea):</label>
          <textarea cols="20" id="f2" name="textarea" rows="2">
      Default text.
      </textarea>
        </div>
        ...
        <fieldset>
          ...
          <div><label htmlFor="f3"><input id="f3" name="radio" type="radio" value="1"/> Radio button 1</label></div>
          <div><label htmlFor="f4"><input checked id="f4" name="radio" type="radio" value="2"/> Radio button 2
            (initially
            checked)</label>
          </div>
        </fieldset>
        <fieldset>
          ...
          <div><label htmlFor="f5"><input id="f5" name="checkbox" type="checkbox"/> Checkbox 1</label></div>
          <div><label htmlFor="f6"><input checked id="f6" name="checkbox2" type="checkbox"/> Checkbox 2 (initially
            checked)</label>
          </div>
        </fieldset>
        <div>
        ...
        <div>
          <label htmlFor="f11">A <code>select</code> element with <code>size="3"</code>
            (listbox):</label>
        ...
        <div><label htmlFor="f99">Submit button:
          <input id="f99" name="submit" type="submit" value="Just a test"/></label>
        </div>
      </form>
      <h2>Tables</h2>;
      ...
      <p className="limited hyphens">Until recently the great majority of naturalists believed that species were
        immutable
        productions, and had been separately created. This view has been ably maintained by many authors.
      </p>;
      <h3>JavaScript-driven hyphenation</h3>;
      <p className="limited hyphenate">Until recently the great majority of naturalists believed that species were
        immutable
        productions, and had been separately created. This view has been ably maintained by many authors.
      </p>;
      <h3>Explicit hyphenation hints (soft hyphens)</h3>;
      <p className="limited">Un­til re­cent­ly the great
